---
name: narrated-bug-capture
description: Use when a UI bug is hard to understand from text, a previous attempted fix failed, or the user can demonstrate the issue faster than describing it. Guides the agent to request a narrated atsc capture and consume the resulting artifacts.
---
